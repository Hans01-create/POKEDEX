        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="font-body text-[#8888A0] leading-relaxed">
              ...
              stat breakdowns. Search, filter, and explore every Pokémon.
            </p>
            <Link
              href="/pokedex"
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              { label: "Pokémon", value: "1025", sub: "All Generations" },
              { label: "Types",   value: "18+",  sub: "Fully filterable" },
              { label: "Stats",   value: "6",    sub: "Per Pokémon" },
              { label: "Source",  value: "API",  sub: "PokeAPI.co" },
            ].map(({ label, value, sub }) => (
              <div key={label} className="rounded-2xl border border-[#1E1E2E] bg-[#13131A] p-6">
