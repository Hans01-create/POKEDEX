  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="relative">
        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#3A3A4A] text-sm select-none">⌕</span>
        <input
          type="text"
          value={search}
        ...
        {search && (
          <button onClick={() => onSearch("")}
            className="absolute right-3 top-1/2 -translate-y-1/2 text-[#8888A0] hover:text-[#E8E8F0] transition-colors text-lg leading-none">
            ×
          </button>
        )}
      </div>
